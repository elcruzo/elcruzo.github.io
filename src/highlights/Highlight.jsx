        ...
        {line.match(linkRegex) ? (
          line.split(linkRegex).map((part, i) => (
            i % 3 === 0 ? (
              ...
              i % 3 === 1 ? (
                <a key={i} href={line.match(linkRegex)[1]} onClick={() => onLinkClick(line.match(linkRegex)[1])} style={linkStyle}>
    ...
    <div ref={gridRef} style={gridContainerStyle}>
      ...
      {jsonData.map((item, index) => (
        ...
        >
          ...
          <p>{item.date}</p>
          <ul>
            <li>{<TextWithHyperlink text={item.list1} onLinkClick={(url) => window.open(url, '_blank')} />}</li>
            {item.list2 && <li>{<TextWithHyperlink text={item.list2} onLinkClick={(url) => window.open(url, '_blank')} />}</li>}
            {item.list3 && <li>{<TextWithHyperlink text={item.list3} onLinkClick={(url) => window.open(url, '_blank')} />}</li>}
          </ul>
        </div>
      ))}
    </div>
